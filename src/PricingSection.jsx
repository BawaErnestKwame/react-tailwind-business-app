        ...
        <div className= "max-w-6xl mx-auto ">
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
            ...
            <div className= 'max-w-xl mx-auto'>
              ...
              <div className= "text-center flex-col mt-6 w-full">
                <p className="text-xl text-gray-600 mb-4">Ready to get started</p>
                <button className='bg-blue-800 px-4 py-2 rounded-full text-white hover:bg-blue-900 transition-all'>Get Started</button>
              </div>
            </div>
